...
in this paper we have shown that it is reasonable to divide the fee into three
parts depending on type of the utilized resource: network, computation or storage.
The analysis of Ethereum blockchain shows that transactions in such a 3D space are
