...
We propose to divide fee into three parts depending on type of utilized resource:
...
computation-oriented or storage-oriented. The analysis of Ethereum blockchain shows 
that distributions of transactions in the 3-dimensional space extend along the
coordinate axis, allowing to unambiguously distinguish transactions by their
type of the resource consumption. This shows self-consistency of our approach 
and provides the reference parameters for possible implementation.
