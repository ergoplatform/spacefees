...
fee is increasing at a constant rate (see Fig.~\ref{fig:max_t}). The possible
formal implementation of this algorithm is described in Section~\ref{sec:scheduled}.
\begin{figure}
    \centering
