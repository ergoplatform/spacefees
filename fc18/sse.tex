...
The obvious questions here are as follows. What are guiding principles for
...
Assume for now that for every transaction we know for how long its outputs will be
