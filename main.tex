...
\dnote{Боксы с утекающим балансом. Типа "после блока N потратить может кто угодно, но с учетом того, что 90% вернется исходному владельцу"}

\subsection{Pay-as-you-go outputs}

\dnote{Боксы с пост-оплатой, типа когда тратишь аутпут, можешь из него потратить только часть, которая не израсходована за хранение этого аутпута в стейте}
