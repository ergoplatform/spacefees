...
\knote{This constant reward is fixing problem of blockchain instability without block reward \cite{carlsten2016instability} - pretty bold claim - move to further work? }
