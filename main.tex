...
that is very close to estimations from section \ref{eq:ltmean}. In \texitit{Prepaid} model miner rewird will be higher, thus in reasonable conditons miner reward, colleted from fees will be 1-20 times higher, than in regular fee model. \dnote{conclusion}
