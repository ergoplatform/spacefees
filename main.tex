...
\begin{itemize}
  \item{}It is interesting how tokens in a cryptocurrency with a \esse{} fee component can be compared with a Gesell's demurrage currency~\knote{links}. 
  \item{}A possible interesting research vector is how to find appropriate mandatory minimal $f_v$, $f_p$, $f_s$ values. Another question is how these component could be combined in a transaction fee $f$. On possible option is to set $f = max(f_p, f_v, f_s)$.
